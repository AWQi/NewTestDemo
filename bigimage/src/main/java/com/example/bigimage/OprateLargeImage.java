...
public class OprateLargeImage extends  android.support.v7.widget.AppCompatImageView{
        private static final String TAG = "MapActivity";

    public OprateLargeImage(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public   OprateLargeImage (Context context ) {
           super(context);
        init();
    ...
    public OprateLargeImage(Context context, AttributeSet attrs, int defStyleAttr) {
