...
public  class PermissionPageUtils {
    ...
    private static  PermissionPageUtils permissionPageUtils ;
   static public  PermissionPageUtils getInstance(Context context){
        if (permissionPageUtils==null){
            permissionPageUtils = new PermissionPageUtils(context);
        }
        return  new PermissionPageUtils(context);
    }
